...
<header>
    <div class="row bg-dark m-0">
        <div class="col-md-6">
            <div class="time text-white pr-5 text-right pt-2" style="font-size: 0.8em;">الجمعة، ٤ ديسمبر ٢٠٢٠ ١٢:٥٩:٠٣
                م
            </div>
        </div>
        <div class="col-md-6">
...
<div class="container">
    ...
    <div class="row text-center mb-3">
        <img src="img/12144.jpg" width="60%" height="90" alt="" class=" m-auto">
    </div>
        ...
        <div class="col-md-8 pt-3">
            <div class="container" style="direction: ltr;">
                <div class="mySlides" style="display: block;">
                    ...
                    <img src="img/a.jpg" style="width:100%" height="500">
                </div>

                <div class="mySlides" style="display: none;">
                    <div class="numbertext">2 / 6</div>
                    <img src="img/b.jpg" style="width:100%" height="500">
                </div>

                <div class="mySlides" style="display: none;">
                    <div class="numbertext">3 / 6</div>
                    <img src="img/c.jpg" style="width:100%" height="500">
                </div>

                <div class="mySlides" style="display: none;">
                    <div class="numbertext">4 / 6</div>
                    <img src="img/d.jpg" style="width:100%" height="500">
                </div>

                <div class="mySlides" style="display: none;">
                    <div class="numbertext">5 / 6</div>
                    <img src="img/e1.jpg" style="width:100%" height="500">
                </div>

                <div class="mySlides" style="display: none;">
                    <div class="numbertext">6 / 6</div>
                    <img src="img/f.jpg" style="width:100%" height="500">
                </div>
                ...
                <div class="caption-container">
                    <p id="caption">first title</p>
                </div>

                <div class="row">
                    <div class="column">
                        <img class="demo cursor active" src="img/a.jpg" height="100" style="width:100%"
                             onclick="currentSlide(1)" alt="first title">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="img/b.jpg" height="100" style="width:100%"
                             onclick="currentSlide(2)" alt="sec title">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="img/c.jpg" height="100" style="width:100%"
                             onclick="currentSlide(3)" alt="third title">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="img/d.jpg" height="100" style="width:100%"
                             onclick="currentSlide(4)" alt="fourth title">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="img/e1.jpg" height="100" style="width:100%"
                             onclick="currentSlide(5)" alt="fifth title">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="img/f.jpg" height="100" style="width:100%"
                             onclick="currentSlide(6)" alt="sixth title">
                    </div>
                </div>
            </div>
            <p class="my-5">ربما لم يسمع كثيرون بمحافظة العلا السعودية، التابعة لمنطقة المدينة المنورة، ولكن المكان
                استوطنه البشر منذ
                6000 سنة. والمنطقة مغطاة بالصخور الأثرية التي تمتد لمساحة 9000 ميل مربع، في شمال غرب المملكة، تلك الصخور
